<nav class="flex-1 space-y-1 px-2 py-4">
    ...
    <a href="{{ route('categorias.index') }}" @class(["text-gray-300 hover:bg-gray-700 hover:text-white group flex items-center px-2 py-2 text-sm font-medium rounded-md", "bg-gray-900" => Route::currentRouteName() === 'categorias.index'])>
